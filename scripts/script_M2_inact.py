...
with open('pypoptim/configs/real_data_inactivation/M2_real.json') as data_file:
...
with open('pypoptim/configs/real_data_inactivation/M2_real.json', 'w') as outfile:
