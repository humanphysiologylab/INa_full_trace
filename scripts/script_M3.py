...
print(numb)
with open('pypoptim/configs/real_data/M3_real.json') as data_file:
    data = json.load(data_file)
dirname = "data/real/activation/"
output_folder_name = "../../../results/M3_real/"
...
with open('pypoptim/configs/real_data/M3_real.json', 'w') as outfile:
