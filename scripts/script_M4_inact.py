...
with open('pypoptim/configs/real_data_inactivation/M4_real.json') as data_file:
    data = json.load(data_file)

dirname = "data/real/inactivation/"
output_folder_name = "../../../results/M4_real_inact/"
...
with open('pypoptim/configs/real_data_inactivation/M4_real.json', 'w') as outfile:
