...
void compute_algebraic(const realtype time,  N_Vector STATES, N_Vector CONSTANTS,  N_Vector ALGEBRAIC){
  ...
  Ith(ALGEBRAIC,10) = RNM * Ith(CONSTANTS,24) * Ith(CONSTANTS,1) * (Ith(CONSTANTS,29) - Ith(STATES,0))/(Ith(CONSTANTS,24)*Ith(CONSTANTS,1)*Ith(CONSTANTS,25)*Ith(CONSTANTS,15)*(1 - Ith(CONSTANTS,26)));// Ith(RATES,0)
...
void compute_rates(const realtype time,  N_Vector STATES, N_Vector CONSTANTS,  N_Vector ALGEBRAIC, N_Vector RATES){
  ...
  Ith(RATES,0) = (Ith(CONSTANTS,29) - Ith(STATES,0))/(Ith(CONSTANTS,24)*Ith(CONSTANTS,1)*Ith(CONSTANTS,25)*Ith(CONSTANTS,15)*(1 - Ith(CONSTANTS,26)));
