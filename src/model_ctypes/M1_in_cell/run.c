...
int rhs(realtype t, N_Vector y, N_Vector ydot, void *data) {
        ...
        // printf("FIRST A1= %0.4e  A2= %0.4e  A3= %0.4e  A4= %0.4e  A5= %0.4e  A6= %0.4e  A7 %0.4e A8 %0.4e A9 %0.4e A10 %0.4e A11 %0.4e A12 %0.4e \n",NV_DATA_S(V_A)[0],  NV_DATA_S(V_A)[1], NV_DATA_S(V_A)[2], NV_DATA_S(V_A)[3], NV_DATA_S(V_A)[4], NV_DATA_S(V_A)[5], NV_DATA_S(V_A)[6],  NV_DATA_S(V_A)[7], NV_DATA_S(V_A)[8], NV_DATA_S(V_A)[9], NV_DATA_S(V_A)[10], NV_DATA_S(V_A)[11]);
        compute_rates(t, y, V_C, V_A, ydot);
        // printf("SECOND A1= %0.4e  A2= %0.4e  A3= %0.4e  A4= %0.4e  A5= %0.4e  A6= %0.4e  A7 %0.4e A8 %0.4e A9 %0.4e A10 %0.4e A11 %0.4e A12 %0.4e \n",NV_DATA_S(V_A)[0],  NV_DATA_S(V_A)[1], NV_DATA_S(V_A)[2], NV_DATA_S(V_A)[3], NV_DATA_S(V_A)[4], NV_DATA_S(V_A)[5], NV_DATA_S(V_A)[6],  NV_DATA_S(V_A)[7], NV_DATA_S(V_A)[8], NV_DATA_S(V_A)[9], NV_DATA_S(V_A)[10], NV_DATA_S(V_A)[11]);
