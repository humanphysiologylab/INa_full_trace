...
void compute_algebraic(const realtype time,  N_Vector STATES, N_Vector CONSTANTS,  N_Vector ALGEBRAIC){
  ...
  realtype x_c_comp = Ith(CONSTANTS,22);
  realtype x_r_comp = Ith(CONSTANTS,23);
  realtype alpha = Ith(CONSTANTS,24);
  realtype v_off = Ith(CONSTANTS,25);
  realtype v_rev = Ith(CONSTANTS,26);
  realtype v_c = Ith(CONSTANTS,27);
